...
"));
  model ConnectingRod
    ...
    parameter SIunits.Length L=1 "Length of the rod";
    SIunits.Force fRod "Constraint force in direction of the rod";
  protected
...
"),
  ...
  public
    MultiBody.Interfaces.Frame_b frame_c(
      S=Sc,
      r0=r0c,
      v=vc,
      w=wc,
...
"),
  ...
  equation
    ...
    /*Constraint equations on position, velocity and acceleration level*/
    [constraintResidue] = [npy*r_rela; npz*{S_rel[3, 2],-S_rel[3, 1],S_rel[2,
      1]}];
