...
"));
  model InertialSystem "Inertial system"
    ...
    MultiBody.Interfaces.Frame_b frame_b annotation (extent=[90, -15; 120, 15]
      );
    annotation (
      Coordsys(
...
"),
      Icon(
        ...
        Polygon(points=[90, -80; 50, -60; 50, -100; 90, -80], style(
            ...
            fillColor=0,
            fillPattern=1)),
        Line(points=[-80, 70; 90, 70; 90, -80], style(color=0)),
...
"),
    ...
    MultiBody.Interfaces.BodyBase body annotation (extent=[-40, -40; 40, 40]);
  equation
...
"),
    ...
    FrameTranslation frameTranslation(r=r) annotation (extent=[-40, -20; 40,
          20]);
    MultiBody.Interfaces.BodyBase body annotation (extent=[-27.3333, -73.3333
          ; 26, -20]);
  equation
    connect(frame_a, frameTranslation.frame_a) annotation (points=[-105, 0;
          -42, 0], style(color=0, thickness=2));
  equation
    connect(frame_b, frameTranslation.frame_b) annotation (points=[105, 0;
          42, 0], style(color=0, thickness=2));
  equation
...
"),
      Icon(
        ...
        Text(
          ...
          string="r=%r",
          style(color=0))));
    FrameTranslation frameTranslation(r=r) annotation (extent=[-60, -30; 60,
          30]);
    MultiBody.Interfaces.BodyBase body annotation (extent=[-25, -107; 33, -47]
      );
    VisualShape box(
      Shape="box",
      r0=r0,
  ...
  equation
    connect(frame_a, frameTranslation.frame_a) annotation (points=[-105, 0;
          -63, 0]);
  equation
    connect(frameTranslation.frame_b, frame_b) annotation (points=[63, 0;
          105, 0]);
  equation
    box.S = Sa;
    box.r = r0a;
  ...
  model CylinderBody
    ...
    parameter SIunits.Length Length=(sqrt(Axis*Axis)) "Length of cylinder";
...
"),
    ...
    FrameTranslation frameTranslation(r=r) annotation (extent=[-60, -30; 60,
          30]);
    MultiBody.Interfaces.BodyBase body annotation (extent=[-30, -101; 30, -43]
      );
    VisualShape box(
      r0=r0,
      Length=Length,
      ...
      Shape="pipe",
      Material=Material,
      Extra=InnerRadius) annotation (extent=[-20, 40; 40, 100]);
  equation
...
"),
  ...
  equation
    connect(vis.frame_a, frame_a) annotation (points=[-30.5, -70; -70, -70;
          -70, 0; -105, 0]);
  end ShapeBody;
